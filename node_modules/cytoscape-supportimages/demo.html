...
<html>
	...
	<head>
		...
		<script src="http://cytoscape.github.io/cytoscape.js/api/cytoscape.js-2.3.8/cytoscape.js"></script>
		...
		<script>
			$(function(){
				...
				cy.supportimages().addSupportImage({
					name: 'jquery',
					url: 'http://howtodoinjava.com/wp-content/uploads/jquery_logo.png'
				});
				refreshImages();
