...
import {getServerName} from '../api/config.js';
import {getServerURL} from '../api/config.js';
import {extractTokenFromStorage} from '../api/config.js';

// adds the users servers to the side bar
export function appendUserServers(){
...
export function appendCommunities(data, server) {
...
export function appendUserCommunities(data, server) {
